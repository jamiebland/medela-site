      ...
      <ul className="hidden md:flex items-center gap-6 list-none">
        ...
        <li>
          <a
            ...
            className="bg-blue text-white px-4 py-1.5 rounded-full text-[13px] font-semibold shadow-[0_4px_16px_rgba(128,168,235,0.4)] hover:bg-blue-mid hover:shadow-[0_6px_20px_rgba(128,168,235,0.5)] motion-safe:hover:-translate-y-px transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue focus-visible:ring-offset-2"
          >
            Book a session &rarr;
          </a>
        </li>
      ...
      {open && (
        <div className="absolute top-[70px] left-0 right-0 bg-bg/98 backdrop-blur-xl border-b border-blue/[.16] p-6 flex flex-col gap-4 md:hidden z-[199]">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-blue text-white px-5 py-3 rounded-full text-sm font-semibold text-center shadow-[0_4px_16px_rgba(128,168,235,0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue focus-visible:ring-offset-2"
          >
            Book a session &rarr;
          </a>
        </div>
