          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-12 items-center">
            <div>
              ...
              <p className="text-base text-white/55 leading-7 max-w-[500px] mb-7">
                Downloadable activity packs for Grades 1&ndash;4 &mdash; designed by Becs
      ...
      <section className="bg-bg-warm py-20 px-6 md:px-20">
        <div className="max-w-[1180px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[18px] mt-11">
            {[
              { num: 1, icon: "\ud83d\uded2", title: "Choose your pack", desc: "Pick the grade and season that matches your child\u2019s year. Not sure? Grade 2 Fall is a great starting point." },
              { num: 2, icon: "\ud83d\udcb3", title: "Buy securely", desc: "Checkout is handled via Sellfy \u2014 secure, fast, and no account needed. Pay by card or PayPal." },
              { num: 3, icon: "\ud83d\udce5", title: "Download instantly", desc: "Your PDF is available immediately after purchase. You\u2019ll also get an email link so you can download it again anytime." },
              { num: 4, icon: "\ud83d\udda8\ufe0f", title: "Print & use", desc: "Print at home or at a local print shop. The pack works page by page or as a complete unit \u2014 whatever suits your child." },
            ].map((step, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mt-8">
                {[
                  { icon: "\ud83d\udcd6", title: "Literacy activities", desc: "Reading comprehension, phonics practice, creative writing prompts, and vocabulary work \u2014 all season-themed." },
                  { icon: "\ud83d\udd22", title: "Maths activities", desc: "Number, operations, problem-solving and reasoning \u2014 matched to grade expectations and scaffolded for different learners." },
                  { icon: "\ud83d\udd2c", title: "Science & Geography", desc: "Cross-curricular content that makes English and Maths practice feel meaningful by connecting it to the world." },
                  { icon: "\u2705", title: "Answer booklet", desc: "Every pack includes a full answer guide so parents can mark confidently and children get immediate feedback." },
                ].map((feat, i) => (
                  <RevealOnScroll key={feat.title} delay={i % 2}>
                    <div className="bg-bg rounded-[var(--radius)] p-[18px] shadow-[var(--shadow-sm)]">
                      <div className="text-[22px] mb-2">{feat.icon}</div>
            ...
            <RevealOnScroll delay={1}>
              <div className="bg-bg rounded-[var(--radius-lg)] p-7 shadow-[var(--shadow)]">
                <div className="flex items-center gap-3 mb-[18px]">
                  <div className="w-12 h-12 rounded-xl bg-blue-pale flex items-center justify-center text-[22px]">
                    {"\u2744\ufe0f"}
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-[18px]">
                  {["\ud83d\udcd6", "\ud83d\udd22", "\ud83d\udd2c"].map((emoji) => (
                    <div
                      key={emoji}
                      className="bg-white rounded-lg aspect-[3/4] border border-blue/[.15] flex items-center justify-center text-2xl shadow-[var(--shadow-sm)]"
                    >
                      {emoji}
                    </div>
                  ))}
            ...
            {[
              ...
              <RevealOnScroll key={t.name} delay={i}>
                <div className="bg-white rounded-[var(--radius)] p-[22px] shadow-[var(--shadow-sm)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow)] flex flex-col h-full">
                  <div className="text-amber text-[13px] tracking-[2px] mb-3">
                    {"\u2605\u2605\u2605\u2605\u2605"}
                  </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    <div className="w-9 h-9 rounded-full bg-blue-pale flex items-center justify-center text-[15px] shrink-0">
                      {t.avatar}
                    </div>
                    <div>
        ...
        <div className="max-w-[1180px] mx-auto grid md:grid-cols-[auto_1fr] gap-11 items-center relative z-10 text-center md:text-left">
          <div className="w-[140px] h-[140px] rounded-full overflow-hidden border-[3px] border-white/[.15] shrink-0 bg-blue-pale mx-auto md:mx-0">
            <Image
              ...
              alt="Becs \u2014 Educational Therapist and creator of Medela Learning Resources"
              width={140}
              height={140}
          ...
          <div>
            ...
            <h2 className="text-lg md:text-[28px] font-extrabold text-white leading-[1.2] tracking-tight mb-2.5">
              Every pack is created by Becs &mdash; Educational Therapist &amp; Founder
            </h2>
            <p className="text-[15px] text-white/[.52] leading-7 max-w-[540px]">
              These aren&apos;t generic worksheets. Every activity in every pack is
              designed by Becs using the same evidence-based methodology she uses in
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="md:sticky md:top-[116px]">
              ...
              <p className="text-[15px] text-text-mid leading-7 mb-6">
                Still unsure? You can always book a free call with Becs to talk
